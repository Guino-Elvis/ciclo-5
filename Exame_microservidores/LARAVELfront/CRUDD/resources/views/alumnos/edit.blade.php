<x-indexAD>
    <div class="container mt-4">
        <form class="w-full  text-center bg-white rounded-xl pt-5" action="{{ url('/alumnos/'. $alumno->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <h1 class=" text-xl text-slate-400">Editar nuevo alumnos Seccion A Pagina Inicio</h1>
            @csrf
            {{method_field('PATCH')}}
            ...
            <div class="container text-left">
                <div class="flex flex-wrap justify-center items-center -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <input class="appearance-none hidden block w-full bg-gray-200  text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name"type="text" name="id" id="id"
                        value="{{ isset ($alumno->id)?$alumno->id:''}}">
                        <br>
