...
public class prem extends JFrame implements ActionListener {
    ...
    prem() {
        frame = new JFrame(
                "Proposiciones logicas  UPEU JULIACA  ___INTEGRANTES: Guino yujra  ,  Frank choquehuanca  ,  Junior Vilcapaza");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        // Add the ubiquitous "Hello World" label.
        labelmain = new JLabel("<html><h1>Matemática Discreta  Proposiciones_____logicas </h1></html>"); // creating
